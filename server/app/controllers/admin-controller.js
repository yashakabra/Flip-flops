...
import { updateForUnverifiedUsers } from "../service/updateForUnverifiedUsers.js";
dotenv.config();
...
export const addAdminPostDetails = async (request, response) => {
...
export const getUnverifiedUsers = async (request, response) => {
  ...
  const res2 = await updateForUnverifiedUsers(res);
